...
#pageConfig
st.set_page_config(layout="wide", page_title="AI Assistant | Bluechip Asia")
...
st.markdown(
    """ 
    <h5 style='text-align:center;'>Welcome to Bluechip Asia AI Assistant, your intelligent chatbot designed to enhance your data exploration experience</h5>
    """,
    unsafe_allow_html=True)
st.markdown("---")
